...
The principles in this article are framework-agnostic. For a survey of the SDD frameworks practitioners use today — including OpenSpec, BMAD-METHOD, Kiro AI-DLC spec mode, GitHub Spec Kit, Compound Engineering, and others — see [AEE-807: Spec-Driven Development Frameworks in Practice](807).
